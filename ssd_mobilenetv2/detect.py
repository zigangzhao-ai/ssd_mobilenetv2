...
if __name__ == "__main__":
    weight = "/data1/zwq/zzg/SSD_mobilenetv2-with-Focal-loss/weights/ssd_mobilenetv2/mobilenetv2_7000.pth"
    path = r"/data1/zwq/zzg/SSD_mobilenetv2-with-Focal-loss/test_images/6162.jpg"

...
from attention import Bottleneck, SEModule, ECAModule
from data.config import USE_SE, USE_CBAM, USE_ECA
...
class SSD(nn.Module):
    ...
    def __init__(self, phase, size, base, extras, head, num_classes):
        ...
        if USE_SE:
            print("use se")
            # self.SE1 = ECAModule(96, 2, 1)
            # self.SE2 = ECAModule(1280, 2, 1)
            # self.SE3 = ECAModule(512, 2, 1)
            # self.SE4 = ECAModule(256, 2, 1)
            # self.SE5 = ECAModule(256, 2, 1)
            # self.SE6 = ECAModule(128, 2, 1)
            #----------------------------
            # self.SE1 = Bottleneck(96) 
            # self.SE2 = Bottleneck(1280)
            # self.SE3 = Bottleneck(512)
            # self.SE4 = Bottleneck(256)
